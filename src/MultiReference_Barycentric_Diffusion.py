...
from .Encode_Image import images_encoding_barycentric
...
def DDIM_Inversion_Process(model: StableDiffusionXLPipeline, x0: list[np.ndarray], blending_weights: list[float], prompt: str, num_inference_steps: int, guidance_scale) -> T:
    ...
    # 1) Encode Image: Encode the input image into a latent representation using the model's VAE with barycentric interpolation.
    encoded_img = images_encoding_barycentric(model, x0, blending_weights)
